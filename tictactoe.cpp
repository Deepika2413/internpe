...
#include <conio.h>
using namespace std;
int startfile();  //function used for menu
int game();          //function where game is initiated
void asterisk();     //just used for designing
void start();        //function used to display the game board
int checkwin();      //function which will check whether the user win or not
void howtoplay();     //function so that user can know how to play
void gamerule();      //function so that user can see gamerules
void help();         //used to get help
void aboutgame();         //used to display info about game
void credits();        //used to display the credits
int i;
